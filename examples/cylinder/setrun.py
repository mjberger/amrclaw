...
#------------------------------
    ...
    probdata.add_param('xloop1',    2.50000,  ' starting pt x')
    probdata.add_param('yloop1',    2.0000, ' starting pt y')
    ## 1 = SRD
    ## 2 = DRD
    ...
    clawdata.upper[0] = 4.000010e+00          # xupper
    clawdata.lower[1] = 0.000000e+00          # ylower
    clawdata.upper[1] = 4.000000000          # yupper

    # Number of grid cells:
    #clawdata.num_cells[0] = 402   # mx
    #clawdata.num_cells[1] = 402   # my
    ...
    clawdata.restart_file = 'fort.chk00041'  # File to use for restart data
    ...
    clawdata.cfl_desired = 0.5000
    # max Courant number to allow without retaking step with a smaller dt:
    clawdata.cfl_max = 0.5000
