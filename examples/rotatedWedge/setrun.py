...
#    probdata.add_param('nloops',    1,  '# this problem rotates the IC, not geom.')
#    probdata.add_param('xloops',    .39,  '# starting x loc ')
#    probdata.add_param('yloops',    .0001,  '# starting y loc')
    ## 0 = nothing special
    ## 1 = SRD
    ## 2 = DRD
